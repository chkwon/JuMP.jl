...
@objective(m, :nonlinear, Min, 5.04*x[1] + .035*x[2] + 10*x[3] + 3.36*x[5] - .063*x[4]*x[7])

@constraints(m, :nonlinear, begin
    35.82 - .222*x[10] - b*x[9] >= 0
    -133 + 3*x[7] - a*x[10] >= 0
    -(35.82 - .222*x[10] - b*x[9]) + x[9]*(1/b - b) >= 0
    -(-133 + 3*x[7] - a*x[10]) + (1/a - a)*x[10] >= 0
    1.12*x[1] + .13167*x[1]*x[8] - .00667*x[1]*x[8]^2 - a*x[4] >= 0
    57.425 + 1.098*x[8] - .038*x[8]^2 + .325*x[6] - a*x[7] >= 0
    -(1.12*x[1] + .13167*x[1]*x[8] - .00667*x[1]*x[8]^2 - a*x[4]) + (1/a - a)*x[4] >= 0
    -(57.425 + 1.098*x[8] - .038*x[8]^2 + .325*x[6] - a*x[7]) + (1/a - a)*x[7] >= 0
    1.22*x[4] - x[1] - x[5] == 0
